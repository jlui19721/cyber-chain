# @file app/helloworld/pages/notes.py
# @brief Notes page for the HelloWorld application
...
class NotesPage:
    ...
    def render(self) -> Image.Image:
        ...
        draw.text((12, 80), "Notes", fill=(230, 230, 255), font=font)
